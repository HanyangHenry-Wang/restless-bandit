...
for C in C_holder:
  ...
  np.savetxt('simulation_2arms_regret_DPS_s5_cost'+str(C)+'.csv', regret_DPS_s5, delimiter=',')
  np.savetxt('simulation_2arms_choice_DPS_s5_cost'+str(C)+'.csv', choice_DPS_s5, delimiter=',')
  np.savetxt('simulation_2arms_regret_DPS_s10_cost'+str(C)+'.csv', regret_DPS_s10, delimiter=',')
  np.savetxt('simulation_2arms_choice_DPS_s10_cost'+str(C)+'.csv', choice_DPS_s10, delimiter=',')
  np.savetxt('simulation_2arms_regret_DPS_s25_cost'+str(C)+'.csv', regret_DPS_s25, delimiter=',')
  np.savetxt('simulation_2arms_choice_DPS_s25_cost'+str(C)+'.csv', choice_DPS_s25, delimiter=',')
  np.savetxt('2arms_regret_DPTS_cost'+str(C)+'.csv', regret_DPTS, delimiter=',')
  np.savetxt('2arms_choice_DPTS_cost'+str(C)+'.csv', choice_DPTS, delimiter=',')
  np.savetxt('2arms_regret_DPPM_cost'+str(C)+'.csv', regret_DPPM, delimiter=',')
  np.savetxt('2arms_choice_DPPM_cost'+str(C)+'.csv', choice_DPPM, delimiter=',')